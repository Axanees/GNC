...
function steer{
 ...
 set ground_Distance to vxcl(up:vector , LZ-1:position):mag.
 ...
 if(ship:groundspeed < 150){
   set rollPID:setpoint to RtarPID:UPDATE(TIME:SECONDS, -horizontal_distance(LZ-1)).
